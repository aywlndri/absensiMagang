		...
		function setMonthly(m, y){
			...
			if (options.mode == 'event') {
				for(var i = 0; i < dayQty; i++) {
					...
					$('#' + uniqueId + ' .monthly-day-wrap').append('<a href="./tanggalDipilih.php?tanggal='+day+'-'+monthNames[m - 1]+'-'+y+'" class="m-d monthly-day monthly-day-event" data-number="'+day+'"><div class="monthly-day-number">'+day+'</div><div class="monthly-indicator-wrap"></div></a>');
				}
			} else {
				for(var i = 0; i < dayQty; i++) {
					// Fix 0 indexed days
